...
namespace E2ERepositories
{
    public class BusinessRepository : IBusinessRepository
    {
        ...
        public AddBusinessViewModal InsertNewBusiness(string EmployerName
                                    , string BusinessName
                                    ...
                                    , DateTime PaymentDueDate)
        {
            ...
            //using (SqlConnection con = new SqlConnection(constr))
            {
                ...
                var result =  db.sp_InsertNewBusiness(EmployerName
                                    ...
                                    , PaymentDueDate).First();


                return Mapper.Map<sp_InsertNewBusiness_Result, AddBusinessViewModal>(result);
